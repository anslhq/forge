...
export default {
  ...
  // AI assistant (chat) requires server output
  output: 'server',
  chat: {
    enabled: true,
  },
  ...
  cId: '8e164f8b-f4bd-4902-bff9-0ca543ab09f6',
  // Custom theme: eventcatalog.styles.css (shadcn-aligned palette; Scale plan for custom themes)
  theme: 'shadcn',
};
